...
function closeLayer() {
  ...
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>&nbsp;&nbsp;更新角色信息</strong></div>
  <div class="body-content">
    <form id="form-addrole" method="post" class="form-x" action="<%=path%>/system/RoleServlet?m=edit">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=model.getRoleName() %>" name="rolename" data-validate="required:请输入角色名称" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
