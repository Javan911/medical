...
<% 
  ...
  Medical model = new Medical(jgbm);
  // 读取隶属关系列表
		...
		<div class="body-content">
			<form id="form-add" method="post" class="form-x"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=model.getJgbm()%>" name="jgbm"
							readonly="readonly" data-validate="required:请输入医疗机构编码" />
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=model.getZzjgbm()%>" name="zzjgbm"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=model.getDqbm()%>" name="dqbm"
							data-validate="required:必填项" />
						<div class="tips"></div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=model.getZgdw()%>" name="zgdw"
							data-validate="required:必填项" />
						<div class="tips"></div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="Wdate input w50" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',errDealMode:0})"
						 	name="kysj" value="<%=model.getKysj()%>" style="height: 40px;" data-validate="required:必填项" />
						<div class="tips"></div>
					</div>
				</div>
