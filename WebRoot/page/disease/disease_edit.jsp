...
function checkName() {
  ...
  <div class="body-content">
    <form id="form-edit" method="post" class="form-x" action="<%=path%>/system/DiseaseServlet?m=edit">  
    <input type="hidden" name="id" value="<%=model.getId()%>" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" id="diseaseCode" class="input w50" value="<%=model.getDiseaseCode()%>" name="diseaseCode" onchange="checkCode()" data-validate="required:请输入慢性病编码" />
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" id="pinyinCode" class="input w50" value="<%=model.getPinyinCode() %>" name="pinyinCode" data-validate="required:请输入拼音码" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" id="diseaseName" class="input w50" value="<%=model.getDiseaseName()%>" name="diseaseName" onchange="checkName()" data-validate="required:请输入慢性病名称" />
