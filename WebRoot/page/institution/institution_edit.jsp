...
<html>
<%-- 根据请求转发过来的areacode加载农合机构信息 --%>
<%
	String areacode = request.getParameter("areacode");
	Institution model = null;
	try {
		model = new Institution(areacode);
...
<%-- function checkArea() {
  ...
  <div class="body-content">
    <form id="form-edit" method="post" class="form-x" action="<%=path%>/system/InstitutionServlet?m=edit">  
    
      <input id="areacode" name="areacode" value="" type="hidden"/>
      <input id="oldAreacode" name="oldAreacode" value="<%=model.getAreacode()%>" type="hidden"/>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" id="institutionCode" class="input w50" value="<%=model.getInstitutionCode()%>" name="institutionCode" data-validate="required:请输入农合机构编号" />
          <div class="tips"></div>
        </div>
      </div>
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" id="institutionName" class="input w50" value="<%=model.getInstitutionName()%>" name="institutionName" onchange="checkName()" data-validate="required:请输入农合机构名称" />
